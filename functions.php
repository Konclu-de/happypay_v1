...
add_filter( 'block_categories_all', 'happypay_block_category', 10, 2 );
...
function happyday_custom_blocks() {
  ...
  // register homepage banner block
  ...
  // register two column layout block
  acf_register_block_type(array(
    'name'                  => 'two-col-layout', 
    'title'                 => __('Two Column Layout'),
    'description'           => __('A custom two columns layout'),
    'render_template'       => 'blocks/two-col-layout.php',
    'category'              => 'happypay-blocks', 
    'icon'                  => 'columns', 
    'keywords'              => array( '2, 2 col, two columns, two, columns')
  ));
  // register two column layout block with form
  acf_register_block_type(array(
    'name'                  => 'two-col-form-text', 
    'title'                 => __('Two Column Layout With Form'),
    'description'           => __('A custom two column layout with a Contact Form 7 form'),
    'render_template'       => 'blocks/two-col-form-text.php',
    'category'              => 'feedback', 
    'icon'                  => 'columns', 
    'keywords'              => array( '2, 2 col, two columns, two, columns, with form, form, contact form 7')
  ));
  ...
  // register three columns icons block 
  acf_register_block_type(array(
    'name'                  => 'three-icons', 
  ...
  acf_register_block_type(array(
    ...
    'category'              => 'happypay-blocks', 
    'icon'                  => 'chart-area', 
    'keywords'              => array( 'stats block, stats, statistics, block')
  ));
...
function shortcode_happy_pay_contacts() {
  ...
  $operating_hours = get_field('operating_hours', 'options');
  ?>
  ...
  <ul class="contact-details">
    <?php if( !empty($physical_address) ) { ?>
      <li>
        <div class="contact-content">
          <span class="bold uppercase">Address:</span> <?php echo $physical_address; ?>
        </div>
      </li>
    <?php } ?> 
    <?php if( !empty($telephone_number) ) { ?>
      <li>
        <div class="contact-content">
          <span class="bold uppercase">Telephone:</span> <a href="tel:<?php echo $telephone_number; ?>"><?php echo $telephone_number; ?></a>
        </div>
      </li>
    <?php } ?> 
    <?php if( !empty($email_address) ) { ?>
      <li>
        <div class="contact-content">
          <span class="bold uppercase">Email:</span> <a href="mailto:<?php echo $email_address ?>"><?php echo $email_address; ?></a>
        </div>
      </li> 
    <?php } ?> 
    <?php if( !empty($website_url) ) { ?>
      <li>
        <div class="contact-content">
          <span class="bold uppercase">Website:</span> <a href="<?php echo 'https://' . $website_url; ?>" target="_blank"><?php echo $website_url; ?></a>
        </div>
      </li> 
    <?php } ?> 
  </ul>
