...
main {
  ...
  // main margin based on header size
  &.notification_spacing {
    //margin-top: 115px;
  }
  &.no_notification_spacing {
    //margin-top: 92px;
  }
}
...
#preloader {
  ...
  .dot-pulse {
    ...
    color: $yellow;
    box-shadow: 9999px 0 0 -5px $yellow;
    ...
    &:before {
      box-shadow: 9984px 0 0 -5px $yellow;
      animation: dotPulseBefore 1.5s infinite linear;
      animation-delay: 0s;
    }

    &:after {
      box-shadow: 10014px 0 0 -5px $yellow;
...
.section-row {
  ...
  &.two-columns-block {
    ...
    .col-md-6 {
      ...
      img {
        //animation: up-and-down ease-in-out 3s infinite;
        display: block;
        margin: 0 auto;
  ...
  &.our-merchant {
    ...
    #merchants-slick-arrows {
      ...
      #merchants-slide-prev {
        margin-right: 10px;
      }

      #merchants-slide-next {
        margin-left: 10px;
      }
    }
  }
