...
function happypay_widgets_init() {
   ...
   */
   ...
   register_sidebar( array(
    'name'            => __( 'Mainbody Widget Area 1', 'happypay' ),
    'id'              => 'mainbody-widget-area-1',
    'description'     => __( 'Use 1, 2, 3 or 4 widgets.', 'happypay' ),
  ...
  register_sidebar( array(
    'name'            => __( 'Footer Widget Area', 'happypay' ),
...
add_action( 'widgets_init', 'happypay_widgets_init' );